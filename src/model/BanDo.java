	...
	public void veMap(Graphics g){
		for (int i = 0; i < mapGame.length; i++) {
			for (int j = 0; j < mapGame.length; j++) {
				switch (mapGame[i][j]) {
				case CO:
					g.drawImage(hinhAnh.co, i*20+10, j*20+10, null);
					break;
				case BUICO:
					g.drawImage(hinhAnh.buiCo, i*20+10, j*20+10, null);
					break;
				case DA1:
					g.drawImage(hinhAnh.da1, i*20+10, j*20+10, null);
					break;
				case DA2:
					g.drawImage(hinhAnh.da2, i*20+10, j*20+10, null);
					break;
				case DA3:
					g.drawImage(hinhAnh.da3, i*20+10, j*20+10, null);
					break;
				case DA4:
					g.drawImage(hinhAnh.da4, i*20+10, j*20+10, null);
					break;
				case DA5:
					g.drawImage(hinhAnh.da5, i*20+10, j*20+10, null);
					break;
				case THUNG:
					g.drawImage(hinhAnh.thung1, i*20+10, j*20+10, null);
					break;
				case NUOC:
					g.drawImage(hinhAnh.nuoc, i*20+10, j*20+10, null);
					break;
				case CAY:
					g.drawImage(hinhAnh.cay, i*20+10, j*20+10, null);
					break;
				default:
					break;
				}
